...
<header class="bg-white shadow">
    ...
    <div class="header-content">
        ...
        <div class="mx-auto  pt-2 pb-2 ">
            <h5 class="pt-1 ">Lista de Especialidades</h2>
        </div> 
        </div>
        <div class="user">
                ...
                <section class="" style="height: 100%">
                    ...
                    <div class="col-md-12 pe-2 ps-2">
                        <div class="row col-md-12">
                            ...
                            <form class="col-7 row align-items-center" type="get" action="{{ route('EspecialidadesS') }}">
                                <div class="col-8">  
                                    <div
                                ...
                                <table class="table">
                                    <thead class="table-dark text-white">
                                        <tr>
                                            ...
                                            <th class="px-4 py-2 text-white text-center">Trabajo Asignado</th>
                                    ...
                                    <tbody>
                                        @if (true == (isset($especialidades) ? $especialidades : null))
                                        @foreach ($especialidades as $especialidad)
                                            <tr>
                                                <td class="border px-4 py-2 text-center">
                                                    {{ $especialidad->IdEspecialidadPersonal }}</td>
                                                <td class="border px-4 py-2 text-center">
                                                    {{ $especialidad->NombrePersona }}</td>
                                                <td class="border px-4 py-2 text-center">
                                                    {{ $especialidad->NombreTrabajo }}</td>
                                                <td class="border px-4 py-2 text-center">
                                                    {{ $especialidad->TiempoEstimado }}</td>
                                                <td class="border px-4 py-2 text-center">
                                                    <div class="d-flex justify-content-center">
                                                    <a data-bs-toggle="modal"
                                                        data-bs-target="#modalEditar{{ $especialidad->IdEspecialidadPersonal }}"
                                                ...
                                                <td class="border px-4 py-2 text-center">
                                                    <div class="d-flex justify-content-center">
                                                    <a data-bs-toggle="modal"
                                                        data-bs-target="#confirm-delete{{ $especialidad->IdEspecialidadPersonal }}"
                                                        class="d-flex justify-content-center mt-1" style="height: 18px; width: 18px" href="">
                                                ...
                                                <!-- Modal Editar-->
                                                <div class="modal fade" id="modalEditar{{ $especialidad->IdEspecialidadPersonal }}"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">
                                                                    Modificar Especialidad del Personal</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('Especialidades.update', $especialidad->IdEspecialidadPersonal) }}"
                                                                    ...
                                                                    <div class="form-group mb-2" >
                                                                        <label for="nombre"
                                                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre Personal</label>
                                                                        <div
                                                                            class="col-sm-12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                            <select name="IdPersonal" class="form-control" placeholder="" required>
                                                                            @foreach ($personal as $persona)
                                                                            <option  {{($persona->IdPersonal==$especialidad->IdPersonal)? 'selected':'' }} value="{{ $persona->IdPersonal }}"> {{ $persona->NombrePersona }}</option>    
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group mb-2" >
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <option  {{($trabajo->IdTrabajo==$especialidad->IdTrabajo)? 'selected':'' }} value="{{ $trabajo->IdTrabajo }}"> {{ $trabajo->NombreTrabajo }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="Estado" name="Estado"
                                                                        value="Activo" value="{{$especialidad->Estado}}" required>
                                                ...
                                                <div class="modal fade"
                                                    id="confirm-delete{{ $especialidad->IdEspecialidadPersonal }}" tabindex="-1"
                                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">
                                                                    Eliminar Especialidad</h5>
                                                                <button type="button" class="btn-close"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('Especialidades.destroy', $especialidad->IdEspecialidadPersonal) }}"
                                                                    class="max-w-sm mx-auto">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('Especialidades.store') }}" class="max-w-sm mx-auto">
                            @csrf
                            ...
                            <div class="form-group mb-2" >
                                ...
                                <div
                                    ...
                                    <select name="IdPersonal" class="form-control" placeholder="" required>
                                    @foreach ($personal as $persona)
                                    <option  value="{{ $persona->IdPersonal }}"> {{ $persona->NombrePersona }}</option>    
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-2" >
                                ...
                                <div
                                    ...
                                    <select name="IdTrabajo" class="form-control" placeholder="" required>
                                    @foreach ($trabajos as $trabajo)
                                    <option  value="{{ $trabajo->IdTrabajo }}"> {{ $trabajo->NombreTrabajo }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
